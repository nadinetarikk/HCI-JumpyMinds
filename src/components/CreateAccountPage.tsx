...
import rocketBrainImage from 'figma:asset/34a527839f0fbd732e6e52c1db3ca372d2df1f79.png';
    ...
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-6xl grid md:grid-cols-2 gap-16 items-center">
          {/* Left Side - Mascot on Rocket */}
          <div className="flex justify-center">
            <div className="relative">
              <img 
                src={rocketBrainImage} 
                alt="Brain mascot on rocket" 
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="space-y-2">
                <div className="flex items-start">
                  <input type="checkbox" id="child-account" className="w-4 h-4 mt-1 text-orange-500" />
                  <label htmlFor="child-account" className="ml-2 text-sm text-gray-700">
                    I'm creating this account for my child
                  </label>
                </div>
                <div className="flex items-start">
                  <input type="checkbox" id="terms" className="w-4 h-4 mt-1 text-orange-500" />
