import svgPaths from "./svg-b7yx4p9bfy";
import imgReading from "figma:asset/86e49e03d83aefaa7dd8759168dcdf639817c469.png";
...
function Checkbox4() {
  return (
    <div className="content-stretch flex gap-[10px] items-start justify-center relative shrink-0 w-[50px]" data-name="Checkbox">
      <CheckBox3 />
...
function Checkbox6() {
  return (
    <div className="[grid-area:1_/_1] box-border content-stretch flex gap-[10px] items-start ml-0 mt-[46px] relative" data-name="Checkbox">
      <Checkbox2 />
      <Checkbox3 />
      <Checkbox4 />
      <Checkbox5 />
      <div className="relative shrink-0 size-[50px]" data-name="Reading">
        <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none size-full" src={imgReading} />
      </div>
    </div>
  );
}
